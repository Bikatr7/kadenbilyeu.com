...
// icons
import { IconInfoCircle, IconChartBar, IconBulb } from "@tabler/icons-react";
        ...
        <Box>
            <Card title="Experience">
                <Item
                    ...
                    sections={[
                        {
                            ...
                            textColor: "cyan.200",
                            content: [
                                { text: "Full-stack development on Negation Game - a DAO/governance discussion platform", useBullet: true },
                                { text: "Implemented epistemic leverage prototype for economic accountability in opinions", useBullet: true },
                                { text: "Currently developing 'rationales' system for multiplayer perspective representation", useBullet: true },
                                { text: "Tech: React, TypeScript, Node.js, PostgreSQL, Web3 integrations", useBullet: true }
                            ]
                        },
                        {
                    ...
                    tags={["React", "TypeScript", "Node.js", "PostgreSQL", "Web3", "DAO", "Governance", "Full-Stack"]}
                />
                <Item
                    ...
                    sections={[
                        {
                            ...
                            textColor: "cyan.200",
                            content: [
                                { text: "Designed new AI/ML systems for space defense using Python, C++, TensorFlow, and PyTorch", useBullet: true },
                                { text: "Analyzed extensive space data to create new algorithms with ML techniques", useBullet: true },
                                { text: "Enhanced U.S. space domain awareness by improving sensor search and reacquisition capabilities", useBullet: true },
                                { text: "Worked at SDA TAP LAB in Colorado Springs on classified defense projects", useBullet: true }
                            ]
                        },
                        {
                            title: "The Real Talk",
                            ...
                            content: [
                                "The above is my copy paste resume line since I cannot say much about the actual work.",
                    ...
                    sections={[
                        {
                            ...
                            textColor: "cyan.200",
                            content: [
                                { text: "Built data visualization tool for economic simulation using Plotly/Dash", useBullet: true },
                                { text: "Learned Python data science stack (NumPy, Pandas, Scikit-Learn) from scratch", useBullet: true },
                                { text: "Contributed to index wallet powered economy model validation", useBullet: true },
                                { text: "First professional data science experience - moved from Gradio to advanced viz", useBullet: true }
                            ]
                        },
                        {
                    ...
                    sections={[
                        {
                            ...
                            textColor: "cyan.200",
                            content: [
                                { text: "RLHF (Reinforcement Learning from Human Feedback) for LLM training", useBullet: true },
                                { text: "Evaluated and fine-tuned language model outputs across domains", useBullet: true },
                                { text: "Handled everything from general knowledge to advanced coding problems", useBullet: true },
                                { text: "Gig work - flexible hours, aligned with career goals in AI/ML", useBullet: true }
                            ]
                        },
                        {
                    ...
                    sections={[
                        {
                            ...
                            textColor: "cyan.200",
                            content: [
                                { text: "TA for Data Analysis/Statistics (R) and Programming in C with Agile courses", useBullet: true },
                                { text: "Graded assignments, answered student questions, held office hours", useBullet: true },
                                { text: "Direct mentoring and one-on-one help sessions with students", useBullet: true },
                                { text: "Multiple semester appointments until department funding cuts", useBullet: true }
                            ]
                        },
                        {
                    ...
                    sections={[
                        {
                            ...
                            textColor: "cyan.200",
                            content: [
                                { text: "Started coding for others (not just personal projects) in January 2023", useBullet: true },
                                { text: "Mix of paid and unpaid work - mostly closed source unfortunately", useBullet: true },
                                { text: "Ongoing open source contributions, primarily my own projects", useBullet: true },
                                { text: "Continuous gig work alongside full-time positions", useBullet: true }
                            ]
                        },
                        {
                            title: "The Definition Game",
                            icon: <IconBulb size={16} />,
                            content: [
