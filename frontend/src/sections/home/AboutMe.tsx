    ...
    return (
        <Box padding="5">
            <Text fontSize="md" marginBottom="4" color="gray.500">
                My name is Kaden Bilyeu, I also go by the pseudonym Bikatr7. I'm a senior at the University of Colorado Colorado Springs (UCCS) studying Computer Science with a focus in Cybersecurity.
            </Text>
            <Text fontSize="md" marginBottom="4" color="gray.500">
                I'm currently 22 years old and I've been programming since I was 10, nowadays my coding is mostly focused on exploring LLMs, NER/NLP, and other AI/ML technologies. I also make tools to assist with my Japanese learning and translation hobby. Although admittingly I lack the time to work on such things as much as I'd like to. Currently focusing on my current position and working on a homelab.
            </Text>
            <Text fontSize="md" marginBottom="4" color="gray.500">
